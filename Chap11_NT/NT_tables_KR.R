...
KRdata <- KRdata %>%
  ...
  set_variable_labels(waste = "Wastƒed child under 5 years")
...
table_temp <-  KRdata %>% 
  ...
  # "Chap11_NT/Tables_bf.xlsx" で試してください（.xlsではなく.xlsxです）

print(paste0("Saving initial breastfeeding table to ", outputDir))
file_path <- paste0(outputDir, "/Tables_bf.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "initialbf")
...
print(paste0("Saving initial micronutrient table to ", outputDir))
file_path <- paste0(outputDir, "/Tables_nut_ch.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "micro_allchild")
...
print(paste0("Saving initial Bottled Feeding table to ", outputDir))
file_path <- paste0(outputDir, "/Tables_bf.xlsx")
write_sheet_to_excel(data_to_write = table_temp,file_path =  file_path, sheet_name = "bottlefd")
...
print(paste0("Saving IYCF indicators table to ", outputDir))
file_path <- paste0(outputDir, "/Tables_IYCF.xlsx")
write_sheet_to_excel(data_to_write = table_temp,file_path = file_path, sheet_name = "IYCFbf")
...
print(paste0("Saving Food and liquids consumed - bf children table to ", outputDir))
file_path <- paste0(outputDir, "/Tables_IYCF.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "foods_bfchild")
...
print(paste0("Saving Food and liquids consumed - non-bf children to ", outputDir))
file_path <- paste0(outputDir, "/Tables_IYCF.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "foods_nonbfchild")
...
print(paste0("Saving Minimum acceptable diet - bf children to ", outputDir))
file_path <- paste0(outputDir, "/Tables_IYCF.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "mindiet_bfchild")
...
print(paste0("Saving Minimum acceptable diet - non-bf children to ", outputDir))
file_path <- paste0(outputDir, "/Tables_IYCF.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "mindiet_nonbfchild")
...
print(paste0("Saving Minimum acceptable diet - all children to ", outputDir))
file_path <- paste0(outputDir, "/Tables_IYCF.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "mindiet_allchild")
...
print(paste0("Saving Micronutrient intake - youngest children age 6-23 living with the mother to ", outputDir))
file_path <- paste0(outputDir, "/Tables_nut_ch.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "micro_youngestchild")
