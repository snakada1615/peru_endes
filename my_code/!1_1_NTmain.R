...
goAnalysis <- function(year){
  ...
  vars_to_keep <- KRiycf %>%
    ...
    names() %>%
    append(c("year", "age", "v001", "v002", "v003", "v005", "v013", "v022", "v025", "v026", "b4", "v024", "v106", "v190")) # add the variables we need to keep
  ...
  vars_to_keep <- PRdata %>% 
    select(starts_with("nt")) %>%
    names() %>%
    append(c("year", "hv001", "hv002", "hv003", "hv005", "hv013", "hv022", "hv024", "hv025", "hv026", "hc1", "hc27", "hv270", "hv103")) # add the variables we need to keep
