...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Physical", append=TRUE)
# 	**************************************************************************************************
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Person phy", append=TRUE)
# 	**************************************************************************************************
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Sexual", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Person sex", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Age sexual violence", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Type violence", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Help", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_viol.xls"), sheetName = "Sources help", append=TRUE)
# **************************************************************************************************
...
write.xlsx(table_temp, here(chap, "Tables_DV_cntrl.xls"), sheetName = "Marital control", append=TRUE)
# ********************************************************************************
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt phy", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt sex", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt emotional", append=TRUE)
########
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt viol freq", append=TRUE)
########
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt viol byvars", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt viol byempower", append=TRUE)
########
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Any prt viol byvars", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Prt viol by_yrs_marriage", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Injuries", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Violence agst husb by vars", append=TRUE)
...
write.xlsx(table_temp, here(chap, "Tables_DV_prtnr.xls"), sheetName = "Violence agst husb by empowr", append=TRUE)
