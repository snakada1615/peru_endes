...
create_table_slides <- function(tbl_list, table_num, table_name) {
  markdown <- ""
  for (i in seq_along(tbl_list)) {
    label <- paste0("tbl-", table_num, "-", i)
    caption <- paste0(
      "Table ", table_num, "-", i, ". ",
      table_name, " (part ", i, ")"
    )
    
    # Markdown スライドテンプレートを生成
    slide <- sprintf(
      "## %s (part %d)\n\n %s\n\n %s\n\n",
      table_name, i, label, caption,
      ifelse(table_num == 1, "pre", "post"), i
    )
    markdown <- paste0(markdown, slide)
  }
  return(markdown)
}
...
# スライドテキストを生成
slides_pre  <- create_table_slides(tbl_split_pre,  1, "Baseline characteristics")
slides_post <- create_table_slides(tbl_split_post, 2, "Endline characteristics")

```

::: {#tbl-desc-stat01}
![](image/fig_tbl_pre_1.png){width="100%"}

descriptive statistics-1
:::


## Descriptive statistics2 {.fragile}

::: {#tbl-desc-stat02}
![](image/fig_tbl_pre_2.png){width="100%"}

descriptive statistics-2
:::

## Descriptive statistics3 {.fragile}

::: {#tbl-desc-stat03}
![](image/fig_tbl_pre_3.png){width="100%"}

descriptive statistics-3
:::

## Descriptive statistics4 {.fragile}
::: {#tbl-desc-stat04}
![](image/fig_tbl_pre_4.png){width="100%"}

descriptive statistics-4
:::

## Descriptive statistics5 {.fragile}
::: {#tbl-desc-stat01}
![](image/fig_tbl_pre_5.png){width="100%"}

descriptive statistics-5
:::

## Descriptive statistics6 {.fragile}
::: {#tbl-desc-post01}
![](image/fig_tbl_post_1.png){width="100%"}
...
::: {#tbl-desc-post02}
![](image/fig_tbl_post_2.png){width="100%"}
...
::: {#tbl-desc-post03}
![](image/fig_tbl_post_3.png){width="100%"}
...
## Descriptive statistics4 {.fragile}
::: {#tbl-desc-stat04}
![](image/fig_tbl_post_4.png){width="100%"}
...
## Descriptive statistics5 {.fragile}
::: {#tbl-desc-post05}
![](image/fig_tbl_post_5.png){width="100%"}
