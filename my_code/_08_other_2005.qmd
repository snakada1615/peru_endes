...
calculate_child_count_fixed2 <- function(HRdata) {
  ...
  # 変換の確認（任意）
  cat("hv102$01 変換後の分布:\n")
  print(table(HR_clean$`hv102$01`, useNA = "always"))
  cat("hv105$01 変換後の分布（先頭20）:\n")
  print(table(HR_clean$`hv105$01`, useNA = "always")[1:20])
...
goAnalysis <- function(year) {
  ...
  HRdata <- read_spss("/Users/snakada/Library/CloudStorage/GoogleDrive-snakada@g.ecc.u-tokyo.ac.jp/マイドライブ/Peru_work/Peru_endes/spss/2005_DHS/HR/PEHR51FL.SAV") %>%
    rename_with(~ tolower(.x))
  IRdata <- read_spss("/Users/snakada/Library/CloudStorage/GoogleDrive-snakada@g.ecc.u-tokyo.ac.jp/マイドライブ/Peru_work/Peru_endes/spss/2005_DHS/IR/PEIR51FL.SAV") %>%
    rename_with(~ tolower(.x))
