...
# *******************************************************************************
  ...
  # 2005/2006年はファイル名が違うため設定
  myname_RE223132 <- ifelse(my_year == "2005", "REC22312.SAV", "RE223132.SAV")
  
  # ここから抽出開始
  df_rec0111 <- open_endes_file(my_year, "REC0111.SAV") %>%
    add_missing_columns(keep_rec0111) %>% dplyr::select(all_of(keep_rec0111))
  df_RE223132 <- open_endes_file(my_year, myname_RE223132) %>%
  ...
  duplicate_check(df_RE223132, c("caseid"), myname_RE223132)
