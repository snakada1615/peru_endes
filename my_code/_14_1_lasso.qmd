...
df_food_org <- readRDS(
  ...
  mutate(
    ...
    nt_fooddummy_staple_legume = case_when(
      "nt_grains" == 1 | "nt_nuts" == 1| "nt_root" == 1 ~ 1,
      TRUE ~ 0
    ),
    nt_fooddummy_vegetable_fruit = case_when(
      "nt_vegetable" == 1 | "nt_fruit" == 1 | "nt_vita" == 1 ~ 1,
      TRUE ~ 0
    ),
    nt_fooddummy_dairy = case_when(
      "nt_dairy" == 1 | "nt_fed_milk" == 1 ~ 1,
      TRUE ~ 0
    ), 
    nt_fooddummy_ASF = case_when(
      "nt_meatfish" == 1 | "nt_eggs" == 1 ~ 1,
      TRUE ~ 0
    )
  ) %>%
  var_labels(
