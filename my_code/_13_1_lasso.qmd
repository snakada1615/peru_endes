...
"rc_tobc_other", "nt_bbyfood", "nt_ch_micro_vaf", "ms_sex_never"
)

# enaho_で始まる変数を除去リストに追加
drop_temp <- names(df_org)[grepl("enaho_", names(df_org))]
...
# ID・管理用変数
grouping_cols <- c("caseid", "state","treated_status", "treatment_start","group_treated", "wt", "treatment_group", y_var)
