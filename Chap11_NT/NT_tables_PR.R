...
print(paste0("Saving Child's anthropometric indicators to ", outputDir))
file_path <- paste0(outputDir, "/Tables_nut_ch.xlsx")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "child_anthro")
...
print(paste0("Saving Child's anemia indicators to ", outputDir))
file_path <- paste0(outputDir, "/Tables_nut_ch.xls")
write_sheet_to_excel(data_to_write = table_temp, file_path = file_path, sheet_name = "child_anemia")
